...
{
    public class MariLobodaModel : PhysicsModel
    {
        private MariLobodaModelData _data;

        public MariLobodaModel(Aircraft aircraft, Vector3 initialVelocity, MariLobodaModelData data) : base(
